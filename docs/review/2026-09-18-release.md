...
**Later UI delivery (not a new evidence certificate):** Web3D card height/ghost-plate fix shipped on `master` via [PR #46](https://github.com/jd92-beep/hk-insurance-compare/pull/46), Build `20260921.02` — see [2026-09-21-3d-card-height-fill.md](2026-09-21-3d-card-height-fill.md). Policy/data evidence limits in this document still apply.
