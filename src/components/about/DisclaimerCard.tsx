...
const CLAUSES = [
  ...
  "資料快照日期以頁面顯示為準（見下方晶片）。保險公司或會隨時更新產品內容、保費及條款，本網站不保證資料之即時性、完整性或準確性。一切內容以保險公司最新官方文件及正式保單條款為準。",
  "本網站並非持牌保險中介人，不提供保險意見，不銷售保險產品，亦不因投保與否收取任何費用。投保前，請向持牌保險中介人或相關保險公司查詢，並細閱保單條款、產品冊子及利益說明。",
  "「官網即時報價」表示相關公司按個人資料提供報價；本網站不會代為估算保費。站內優惠必須同時具備官方來源、條件及有效日期先會顯示；未核實優惠唔會當成現時可買價格。",
