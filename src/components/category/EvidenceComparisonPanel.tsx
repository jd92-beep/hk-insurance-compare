  ...
  return <section className="border-b border-line bg-paper py-10 md:py-14" aria-labelledby="evidence-chart-title" data-evidence-chart>
    <div className="site-container">
      <div className="flex flex-col justify-between gap-5 md:flex-row md:items-end">
        <div className="max-w-2xl"><p className="eyebrow text-jade">LIMITS, WITH CONTEXT</p><h2 id="evidence-chart-title" className="mt-3 font-serif text-2xl font-bold md:text-3xl">數字背後，要有同一把尺。</h2><p className="mt-3 text-sm leading-relaxed text-ink-soft">只將同名保障、明示港元、相同期間及相同賠償對象分組展示。無上限、未提供、不同級別或有條件的摘要保留原文，唔會硬換成數字排名。</p></div>
