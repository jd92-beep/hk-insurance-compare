...
export const CATEGORY_PERSONA_PRESETS: Record<string, PersonaPreset[]> = {
  ...
  travel: [
    {
      ...
      label: "🚗 自駕遊達人",
      icon: "🚗",
      description: "海外自駕：租車自負額、緊急救援、個人責任",
    ...
    },
    {
      ...
      label: "👨‍👩‍👧 親子家庭 / 三代同堂遊",
      icon: "👨‍👩‍👧",
      description: "親子／長者：受保年齡、兒童保障、覆診",
    ...
    },
    {
      ...
      label: "🚢 郵輪假期深度遊",
      icon: "🚢",
      description: "郵輪：泊岸延誤、岸上觀光、取消、救援",
  ...
  medical: [
    ...
    },
    {
      ...
      label: "🔬 癌症門診精準治療",
      icon: "🔬",
      description: "癌症治療、CT/MRI 造影、門診洗腎",
  ...
  "top-up-medical": [
    ...
    },
    {
      ...
      label: "🩺 門診小手術與先進造影加強",
      icon: "🩺",
      description: "日間手術、CT/MRI 差額、出院後覆診",
  ...
  "critical-illness": [
    ...
    },
    {
      ...
      label: "💎 儲蓄分紅終身與良性病變預防",
      icon: "💎",
      description: "儲蓄分紅、良性腫瘤、多重危疾、ICU",
  ...
  accident: [
    {
      ...
      label: "⛷️ 戶外運動達人",
      icon: "⛷️",
      description: "滑雪／潛水等運動；骨折、物理治療、救援",
  ...
  life: [
    {
      ...
      label: "👨‍👩‍👧 家庭經濟支柱 (高額純定期)",
      icon: "👨‍👩‍👧",
      description: "高額定期、末期預支、意外雙倍、非吸煙",
